...
Public Class Form1
    ...
    Private Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        frm.Visible = True
        frm.lbltotalfilecount.Text = filenamelist.Count.ToString
        frm.ProgressBar1.Maximum = filenamelist.Count
        ...
        For Each g In filelist
            ...
            If CheckBox2.Checked = True Then
                ...
                ElseIf interval <> "" Then
                    Dim rrr As New SQLExecution()
                    Dim eee As New ReportWriter()
                    rrr.SQLCommander("RepeatsPerXMinutes", interval, "", "")
                    eee.WriteCSV(g.Substring(0, g.Length - 4), "Repeats_Per" + interval + "Minutes", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
            ...
            If CheckBox3.Checked = True Then
                ...
                ElseIf distance <> "" Then
                    Dim rrr As New SQLExecution()
                    Dim eee As New ReportWriter()
                    rrr.SQLCommander("CoordinateJumpCount", "", distance, "")
                    eee.WriteCSV(g.Substring(0, g.Length - 4), "CoordinateJumpCount", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
            ...
            If CheckBox4.Checked Then
                ...
                Dim rrr As New SQLExecution()
                Dim eee As New ReportWriter()
                rrr.SQLCommander("RepeatedIntervals", "", "", "")
                eee.WriteCSV(g.Substring(0, g.Length - 4), "RepeatedIntervals", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
            ...
            If CheckBox7.Checked = True Then
                ...
                Dim rrr As New SQLExecution()
                Dim eee As New ReportWriter()
                rrr.SQLCommander("RepeatCoordinateJumpAnalysis", "", "", "")
                eee.WriteCSV(g.Substring(0, g.Length - 4), "RepeatedJumpAnalysis", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
            ...
            For Each g In filenamelist
                ...
                If CheckBox6.Checked = True Or CheckBox5.Checked = True Then
                    Try
                        ...
                        frm.Refresh()
                        Dim tbl As New TableKreator()
                        tbl.CreateTables("RAWDataInsertion", rawFilename, rawfilefirstrow, formatfile)
                ...
                If CheckBox5.Checked = True Then
                    ...
                    Dim rrr As New SQLExecution()
                    Dim eee As New ReportWriter()
                    rrr.SQLCommander("ReaderAnalysis", "", "", "")
                    eee.WriteCSV(g.Substring(0, g.Length - 4), "ReaderAnalysis", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
                ...
                If CheckBox6.Checked = True Then
                    ...
                    Dim rrr As New SQLExecution()
                    Dim eee As New ReportWriter()
                    rrr.SQLCommander("DroppedPackets", "", "", "")
                    eee.WriteCSV(g.Substring(0, g.Length - 4), "DroppedPackets", saveFileLocation, filedictionary, filedictionary2, rawfilelist)
                ...
                If CheckBox8.Checked = True Then
                    ...
                    Else
                        Dim loggingservce As New LoggingServices()
                        Dim createfiles As Boolean = loggingservce.LoggingService(rawFilename)
        ...
        If combinereports = True Then
            frm.lblcurrenttask.Text = "Compiling RAW Reports"
            frm.Refresh()
            Dim krpts As New KombineReports()
            krpts.CombineRawFileReports(True, rawfilelist, saveFileLocation, filedictionary, filedictionary2)
            'Dim doreports As Boolean = CombineRawFileReports(True)
        End If
        If CheckBox1.Checked = True And filelist.Count > 1 Then
            frm.lblcurrenttask.Text = "Compiling Daily Reports"
            frm.Refresh()
            Dim krpts As New KombineReports()
            tagerrordictionary = krpts.TotalCTReport(True, filedictionary, filedictionary2, saveFileLocation, rawfilelist)
        ...
        If tagerrordictionary.Count > 0 Then
            ...
            For Each assetid In tagerrordictionary.Keys()
                ...
                Form3.ListView1.Items.Add("Asset ID " + assetid + " returned " + CStr(keylist * 100) + "% repeated positions")
